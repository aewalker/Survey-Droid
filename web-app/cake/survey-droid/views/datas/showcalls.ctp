<?php
/*---------------------------------------------------------------------------*
 * views/datas/showcalls.ctp                                                 *
 *                                                                           *
 * Show call logs for a subject.                                             *
 *---------------------------------------------------------------------------*/
echo $this->Session->flash();

$_SESSION['exportData'] = $results;
$_SESSION['exportColumnNames'] =
	array('Contact Id', 'Call Type', 'Duration', 'Time');
$_SESSION['info'] = 'Call type --> outgoing call 0, incoming call 1,'
	.'outgoing text 2, incoming text 3, missed call 4';
$_SESSION['pagename'] = "Call logs for subject $subjectid";

//show the results
echo $tablefordata->startTable('Call',
	array('Contact Id', 'Call Type', 'Duration', 'Time'));
