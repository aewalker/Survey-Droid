...
public final class Util
{
	...
	private static final boolean USE_APP_TAG = false;
	...
	public static long getUnixTime(String day, String time, long base)
	{
		...
		if (returnTime < base)
		{
			//don't use roll, it causes problems during the last week of the year
	...
	public static String cleanPhoneNumber(String number)
	{
		...
		//TODO this whole thing is messed up; do some research and fix it
		String countryCode = "1";
		if (sb.length() == 9 + countryCode.length())
		{
